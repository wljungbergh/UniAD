...
model = dict(
    ...
    freeze_bev_encoder=False, # we dont have one
    score_thresh=0.4,
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            ...
            use_can_bus=True,
            embed_dims=_dim_,
            encoder=None, # we dont use the encoder - we have our own
            decoder=dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='data/nuscenes/others/motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
...
load_from = "ckpts/uniad_base_track_map_dos.pth"